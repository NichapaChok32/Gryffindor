...
async function deleteQueue(
    project = 'gryffindor-1550651944789', // Your GCP Project id
    queue = 'gryffindor', // Name of the Queue to create
    location = 'asia-south1' // The GCP region in which to create the queue
) {
